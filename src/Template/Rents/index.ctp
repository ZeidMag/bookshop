    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('duration_days') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $rent->user_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $rent->user_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $rent->user_id], ['confirm' => __('Are you sure you want to delete # {0}?', $rent->user_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
